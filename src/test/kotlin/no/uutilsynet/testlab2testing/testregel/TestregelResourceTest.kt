...
class TestregelResourceTest {
 ...
 private val resource = TestregelResource(
  kravregisterClient,
 ...
 fun `getTestregelAggregates returns correct aggregates`() {
  ...
  val krav = KravWcag2x(id = 5, tittel = "Krav", status = KravStatus.gjeldande, innhald = "Innhald", gjeldAutomat = true,
   gjeldNettsider = true, gjeldApp = false, urlRettleiing = "http://example.com",
   prinsipp = WcagPrinsipp.robust, retningslinje = WcagRetninglinje.leselig, suksesskriterium = "Kriterium",
   samsvarsnivaa = WcagSamsvarsnivaa.AA, kommentarBrudd = "Kommentar")
