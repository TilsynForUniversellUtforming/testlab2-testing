 ...
 * @param testrunUuid 
 */
data class TestresultatResponse(
    ...
    @get:JsonProperty("elementResultat") val elementResultat: TestresultatResponse.ElementResultat? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): ElementResultat {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'TestresultatResponse'")
            }
        }
    }
