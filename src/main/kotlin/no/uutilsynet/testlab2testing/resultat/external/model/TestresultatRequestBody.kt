 ...
 * @param testrunUuid 
 */
data class TestresultatRequestBody(

    @get:JsonProperty("id") val id: kotlin.Long? = null,

    @get:JsonProperty("testgrunnlag") val testgrunnlag: kotlin.String? = null,
    ...
    @get:JsonProperty("elementResultat") val elementResultat: TestresultatRequestBody.ElementResultat? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): ElementResultat {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'TestresultatRequestBody'")
            }
        }
    }
