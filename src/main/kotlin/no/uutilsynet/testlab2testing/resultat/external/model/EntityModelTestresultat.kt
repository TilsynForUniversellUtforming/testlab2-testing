 ...
 * @param links 
 */
data class EntityModelTestresultat(
    ...
    @get:JsonProperty("elementResultat") val elementResultat: EntityModelTestresultat.ElementResultat? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): ElementResultat {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'EntityModelTestresultat'")
            }
        }
    }
