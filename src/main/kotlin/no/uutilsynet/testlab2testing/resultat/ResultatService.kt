...
class ResultatService(
    ...
    private fun resultatForKontrollType(kontrolltype: Kontrolltype, kontrollId: Int): List<Resultat> {
        return getKontrollResultatCommon{getResultatService(kontrolltype).getKontrollResultat(kontrollId)}
    }
    ...
    private fun List<ResultatLoeysingDTO>.toResultatOversiktLoeysing():List<ResultatOversiktLoeysing> {
    ...
    private fun getResultService(kontrollId: Int): KontrollResultatService {
        ...
        return when (kontrolltype) {
            Kontrolltype.ForenklaKontroll, Kontrolltype.Statusmaaling ->
                automatiskResultatService

            Kontrolltype.InngaaendeKontroll, Kontrolltype.Tilsyn, Kontrolltype.Uttalesak ->
