alter table testlab2_testing.testresultat
drop column nettside_id;
...
alter table testlab2_testing.testresultat
add column maaling_id          integer references maalingv1(id);

alter table testlab2_testing.testresultat
add column crawl_side_id          integer references crawl_side(id);
